...
<div class="row">
    <div class="col-md-12">
        ...
        <div class="card card-custom gutter-b example example-compact">
            ...
            <!--begin::Form-->
            <form id="start-quiz-image" enctype="multipart/form-data" method="POST">
                @csrf
                        ...
                        <div class="form-group">
                            ...
                            <div class="">
                                <div class="image-input image-input-outline" id="kt_image_1">
                                    <div class="image-input-wrapper my-avtar" style="background-image: url({{ asset('public/uploads/startquiz/'.$details['image'] )}})"></div>
