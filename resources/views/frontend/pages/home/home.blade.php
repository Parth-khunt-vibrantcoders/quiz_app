                        ...
                        @foreach ($question_list as $key => $value)
                            <div class="{{ $i == 1 ? '' : 'hidden'}} questiondiv" id="question_answer{{$i}}">
                                ...
                                <ul>
                                    ...
                                    <li class="answerui">
                                        <label>
                                            <input type="radio" id="" class="answer-btn" data-question="{{$i}}" value="2" id="2" name="age-rang">
                                            <span>{{ $value['answer2']}} </span>
                                        </label>
                                    </li>
                                    <li class="answerui">
                                        <label>
                                            <input type="radio" id="" class="answer-btn" data-question="{{$i}}" value="3" id="3" name="age-rang">
                                            <span>{{ $value['answer3']}} </span>
                                        </label>
                                    </li>
                                    <li class="answerui">
                                        <label>
                                            <input type="radio" id="" class="answer-btn" data-question="{{$i}}" value="4" id="4" name="age-rang">
